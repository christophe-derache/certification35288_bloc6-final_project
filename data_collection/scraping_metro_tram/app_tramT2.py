...
browser.get("http://www.ferro-lyon.net/nouveau-tram/ligne-T2/T2-station-par-station/")
...
# LOOP
for i in range(1,33):
    dict = {'name':'', 'link':'', 'line': 'T2', 'city':'lyon'}
    ...
    if i == 32:
        df.to_csv('save_output_scrapping/output_tram_T2.csv')
        browser.quit()
    else:
        browser.back()