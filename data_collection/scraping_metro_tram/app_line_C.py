...
browser.get("http://www.ferro-lyon.net/Metro-C/Ligne-C-station-par-station/")
...
# LOOP
for i in range(1,6):
    dict = {'name':'', 'link':'', 'line': 'C', 'city':'lyon'}
    ...
    if i == 5:
        df.to_csv('save_output_scrapping/output_line_C.csv')
        browser.quit()
    else:
        browser.back()