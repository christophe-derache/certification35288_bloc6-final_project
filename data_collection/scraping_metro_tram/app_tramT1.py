...
browser.get("http://www.ferro-lyon.net/nouveau-tram/ligne-T1/T1-station-par-station/")
...
# LOOP
for i in range(1,28):
    dict = {'name':'', 'link':'', 'line': 'T1', 'city':'lyon'}
    ...
    if i == 27:
        df.to_csv('save_output_scrapping/output_tram_T1.csv')
        browser.quit()
    else:
        browser.back()