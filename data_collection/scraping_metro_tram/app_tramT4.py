...
browser.get("http://www.ferro-lyon.net/nouveau-tram/ligne-T4/T4-station-par-station/")
...
# LOOP
for i in range(1,30):
    dict = {'name':'', 'link':'', 'line': 'T4', 'city':'lyon'}
    ...
    if i == 29:
        df.to_csv('save_output_scrapping/output_tram_T4.csv')
        browser.quit()
    else:
        browser.back()