...
browser.get("http://www.ferro-lyon.net/nouveau-tram/ligne-T5/T5-station-par-station/")
...
# LOOP
for i in range(1,12):
    dict = {'name':'', 'link':'', 'line': 'T5', 'city':'lyon'}
    ...
    if i == 11:
        df.to_csv('save_output_scrapping/output_tram_T5.csv')
        browser.quit()
    else:
        browser.back()