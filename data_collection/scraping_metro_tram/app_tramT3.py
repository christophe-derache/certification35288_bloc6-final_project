...
browser.get("http://www.ferro-lyon.net/nouveau-tram/ligne-T3/T3-Rhonexpress-station-par-station/")
...
# LOOP
for i in range(1,4):
    dict = {'name':'', 'link':'', 'line': 'T3', 'city':'lyon'}
    ...
    if i == 3:
        df.to_csv('save_output_scrapping/output_tram_T3.csv')
        browser.quit()
    else:
        browser.back()