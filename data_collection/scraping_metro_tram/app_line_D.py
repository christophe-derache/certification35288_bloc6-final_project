...
browser.get("http://www.ferro-lyon.net/Metro-sur-pneus/ligne-D/Ligne-D-station-par-station/")
...
# LOOP
for i in range(1,16):
    dict = {'name':'', 'link':'', 'line': 'D', 'city':'lyon'}
    ...
    if i == 15:
        df.to_csv('save_output_scrapping/output_line_D.csv')
        browser.quit()
    else:
        browser.back()